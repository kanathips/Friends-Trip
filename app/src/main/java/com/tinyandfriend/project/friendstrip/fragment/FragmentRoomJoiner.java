...
//        final ImageView imageView = (ImageView) view.rootView.findViewById(R.id.image_detail);
//        final TextView room_name = (TextView) view.rootView.findViewById(R.id.room_name_text);
//        final TextView room_spoil = (TextView) view.rootView.findViewById(R.id.room_spoil_text);
//        final FloatingActionButton convertMap = (FloatingActionButton) view.rootView.findViewById(R.id.convert_map);
//
...
////
////                final RecyclerView joinerList = (RecyclerView) dialog.rootView.findViewById(R.id.joiner_list);
////                final ArrayList<FriendInfo> members = new ArrayList<>();
////                reference.child(ConstantValue.TRIP_ROOM_CHILD).child(tripId).child("members").addListenerForSingleValueEvent(
...
////                dialog.setCancelable(true);
////
////                final CircleImageView profile_host = (CircleImageView) dialog.rootView.findViewById(R.id.content_avatar_image);
////                final TextView name_host = (TextView) dialog.rootView.findViewById(R.id.content_name_view);
////                final TextView content_from_date = (TextView) dialog.rootView.findViewById(R.id.content_from_date);
////                final TextView content_to_date = (TextView) dialog.rootView.findViewById(R.id.content_to_date);
////                final TextView text_count = (TextView) dialog.rootView.findViewById(R.id.head_text_count);
////
////                reference.child(ConstantValue.TRIP_ROOM_CHILD).child(tripId).addListenerForSingleValueEvent(new ValueEventListener() {
////                    @Override
////                    public void onDataChange(DataSnapshot dataSnapshot) {
...
//                final TextView content_to_date = (TextView) dialog.rootView.findViewById(R.id.content_to_date);
//                final TextView text_count = (TextView) dialog.rootView.findViewById(R.id.head_text_count);
//                final Button fileButton = (Button) dialog.rootView.findViewById(R.id.content_deadline_time);
//
//                reference.child(ConstantValue.TRIP_ROOM_CHILD).child(tripId).addListenerForSingleValueEvent(new ValueEventListener() {
//                    @Override
//                    public void onDataChange(DataSnapshot dataSnapshot) {
...
//                                    i.setData(Uri.parse((String) file.get(0)));
//                                    startActivity(i);
//                                }
//                            });
//                        }
...
//        });
//
//        FloatingActionButton exitFab = (FloatingActionButton) view.rootView.findViewById(R.id.out_trip);
...
//        mapView = (MapView) view.rootView.findViewById(R.id.map);
